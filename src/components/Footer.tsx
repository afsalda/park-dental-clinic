          ...
          <div className="footer-grid">
            ...
            <div className="footer-brand">
              ...
              <div className="footer-social">
                {/* Facebook */}
                <a
                  href="https://share.google/LOH3LxWYXsvCyEu7d"
                  target="_blank"
                  rel="noopener"
            ...
            <div className="footer-col">
              ...
              <nav className="footer-links" aria-label="Footer quick links">
                ...
                <Link href="/best-dental-clinics-kochi-reddit" className="footer-link">
              ...
              <div>
                <div className="footer-contact-item">
                  <a
                    ...
                    style={{ display: "flex", alignItems: "flex-start", gap: "var(--space-md)", textDecoration: "none", color: "inherit", width: "100%" }}
                  >
